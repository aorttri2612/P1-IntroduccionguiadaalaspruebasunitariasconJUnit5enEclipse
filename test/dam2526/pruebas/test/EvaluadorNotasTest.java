...
public class EvaluadorNotasTest {
    ...
    @Test
    void notaNegativa_mensajeCorrecto() {
        EvaluadorNotas evaluador = new EvaluadorNotas();

        Exception ex = assertThrows(IllegalArgumentException.class, () -> evaluador.clasificarNota(-1));
        assertEquals("La nota debe estar entre 0 y 10.", ex.getMessage());
    }
}